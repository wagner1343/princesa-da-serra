...
public class LoadAllSegmentsByCitySailId extends Task<Boolean, List<Segment>, Integer> {

    private PDSDatabaseConnectionPool connectionPool = null;
    private Long key = null;

    public LoadAllSegmentsByCitySailId(PDSDatabaseConnectionPool connectionPool, Long key){
    ...
    protected List<Segment> execute(Boolean useless){
        ...
        try{
            ...
            segmentes = segmentRepository.findByCitySail(key);
