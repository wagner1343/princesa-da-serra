...
public class TripSaleRepository implements Repository<TripSale, Long> {
    ...
    private static class SQLQueries {
        ...
        private static final String SELECT_TRIPSALE = "SELECT *, r.name as namer, uu.id_user as id_useru, uu.first_name as first_nameu, ue.id_user as id_usere, ue.first_name as first_namee, ca.name as namea, cs.name as names from sells s join users uu on s.id_user = uu.id_user join users ue on s.id_employee = ue.id_user join cities ca on s.id_cityArrival = ca.id_city join cities cs on s.id_citySail = cs.id_city join trips t on s.id_trip = t.id_trip join route r on t.id_route = r.id_route where id_sell = ?";
        private static final String SELECT_ALL_TRIPSALE = "SELECT *, r.name as namer, uu.id_user as id_useru, uu.first_name as first_nameu, ue.id_user as id_usere, ue.first_name as first_namee, ca.name as namea, cs.name as names from sells s join users uu on s.id_user = uu.id_user join users ue on s.id_employee = ue.id_user join cities ca on s.id_cityArrival = ca.id_city join cities cs on s.id_citySail = cs.id_city join trips t on s.id_trip = t.id_trip join route r on t.id_route = r.id_route";
        private static final String SELECT_BY_USER_TRIPSALE = "SELECT *, r.name as namer, uu.id_user as id_useru, uu.first_name as first_nameu, ue.id_user as id_usere, ue.first_name as first_namee, ca.name as namea, cs.name as names from sells s join users uu on s.id_user = uu.id_user join users ue on s.id_employee = ue.id_user join cities ca on s.id_cityArrival = ca.id_city join cities cs on s.id_citySail = cs.id_city join trips t on s.id_trip = t.id_trip join route r on t.id_route = r.id_route where id_user = ?";
        private static final String SELECT_BY_TRIP_TRIPSALE = "SELECT *, r.name as namer, uu.id_user as id_useru, uu.first_name as first_nameu, ue.id_user as id_usere, ue.first_name as first_namee, ca.name as namea, cs.name as names from sells s join users uu on s.id_user = uu.id_user join users ue on s.id_employee = ue.id_user join cities ca on s.id_cityArrival = ca.id_city join cities cs on s.id_citySail = cs.id_city join trips t on s.id_trip = t.id_trip join route r on t.id_route = r.id_route where id_trip = ?";
